...
const KNOWLEDGE_CONTENT = {
  ...
  "архитектура платформы":
    "SetHubble — это гибридная экосистема, которая объединяет онлайн и офлайн бизнес. Здесь нет стартовых пакетов, как в сетевом. Ты получаешь процент с реального оборота чужих бизнесов.",
  "теория модуля 1":
    "В первом модуле мы разбираем, как устроена система умных денег. Ты не зависишь от разового трафика, а строишь вечный инфраструктурный доход.",
  "возможности партнеров":
    "Партнеры могут подключать бизнесы. Бизнес дает клиентам QR-код, клиенты сканируют его ради скидки и навсегда закрепляются в твоей структуре.",
  "теория модулей 1-2":
    "Мы разобрали архитектуру платформы и поняли, как бизнес сам строит тебе сеть через QR-коды. Это эффект лесного пожара.",
  "теория модулей 1-3":
    "Мы разобрали архитектуру, работу офлайн-точек через QR-коды и перешли к онлайну. Онлайн-бизнес монетизирует даже отказников: те, кто не купил курс блогера, всё равно идут в систему и приносят ему доход.",
  "теория модулей 1-4":
    "Мы прошли все основы: как работает платформа, как оцифровать офлайн (салоны, СТО) и как онлайн-авторы монетизируют 100% своего трафика.",
  "бинар":
    "Бинарная система доступна на тарифе Shuttle. Ты получаешь бонус каждый раз, когда накапливается 1000 симметричных баллов слева и справа. Глубина не ограничена.",
  "компрессия":
    "Если кто-то на бесплатном тарифе в твоей сети делает продажу, часть денег пролетает мимо него и оседает у тебя, так как у тебя есть PRO-статус.",
  "весь теор. курс":
    "Теоретический курс состоит из 5 уроков: архитектура, офлайн-бизнес (QR-коды), онлайн-бизнес (монетизация трафика), O2O-генератор (переход из онлайна в офлайн) и математика (бинар и компрессия).",
  "введение в обучение":
    "Сейчас мы переходим к практике. За прохождение этапов ты получаешь NeuroCoins. 100 монет дают скидку 50% на PRO-статус.",
  "модуль 1: стратегия заработка":
    "Первый практический шаг — изучение стратегии. Это план того, как именно мы будем привлекать трафик и выстраивать воронку.",
  "модуль 1":
    "Модуль 1 учит выстраивать стратегию и понимать, откуда берутся деньги в экосистеме SetHubble.",
  "модуль 2: онлайн-бизнес":
    "В Модуле 2 мы настраиваем твоего ИИ-клона и упаковываем воронку, чтобы она конвертировала трафик в деньги 24/7.",
  "модуль 2":
    "Модуль 2 посвящен запуску твоего ИИ-помощника и сборке автоворонки.",
  "модуль 3: офлайн-бизнес":
    "В Модуле 3 мы разбираем бронебойную B2B-связку «Троянский конь». Как с помощью PDF-презентации и QR-кода подключать целые компании.",
  "все 3 модуля":
    "Ты прошел Модуль 1 (Стратегия), Модуль 2 (Онлайн и запуск бота) и Модуль 3 (Офлайн и B2B). Теперь система полностью готова к работе.",
  "PRO-статус":
    "PRO стоит $40, но за 100 монет можно забрать за $20. Он дает 50% комиссии, пассив до 5 уровней, CRM и 8 ИИ-приложений.",
  "PRO-контент":
    "Для PRO-партнеров открыт Лаборатория NeuroGen: генерация сайтов, сценариев, видео и креативов через ИИ.",
  "инструкции по использованию":
    "В PRO-обучении мы по шагам соберем лендинг, задеплоим его на GitHub Pages, напишем нейро-тексты и запустим рекламу в Яндекс.Директ.",
  "модуль 1: дизайн":
    "В PRO мы используем ИИ для копирования стиля любого топового сайта (Style Transfer) и собираем лендинг без кода.",
  "модули 1-2: дизайн и сайты":
    "Мы научились генерировать лендинги и упаковывать их через ИИ для публикации.",
  "модули 1-3: дизайн, сайты, боты":
    "Мы сделали сайт, настроили деплой и подключили ИИ-бота через сценарии n8n и Monetization.",
  "модули 1-4: полный курс":
    "Ты стал Архитектором! У тебя есть сайт, бот, трафик с Яндекса и виральные видео.",
  "тариф Rocket":
    "Стоит $85/год. Открывает доходы до 10 поколений в глубину, компрессию (заработок на ленивых агентах) и быстрые авто-выплаты.",
  "тарифы Rocket и Shuttle":
    "Rocket ($85/год) дает 10 уровней и компрессию. Shuttle ($350/год) дает бесконечный бинар и неограниченный потенциал чеков.",
  "всё бесплатное":
    "На бесплатном тарифе ты получаешь 25% комиссии с личных продаж и по 3% со 2 и 3 уровня. Без CRM и без ИИ-инструментов.",
  "все материалы":
    "Включают в себя Promo-Kit (сайт-визитка, QR-коды), базовое обучение и партнерский кабинет.",
};
